...
public class RoundedPanel extends SimplePanel {
  ...
  public final static int TOPBOTTOMRIGHT = TOP | BOTTOMRIGHT;
   ...
   */
  private static String RPSTYLE = "cbg-RP";
  ...
  private final static String[][] CORNERMARGIN = {
    { "1px","2px" }, { "1px", "2px" ,"3px","5px"}, { "1px", "2px", "3px" ,"5px"},
    { "1px", "2px", "3px", "4px" ,"6px"}, { "1px", "2px", "3px", "4px", "6px" ,"8px"},
    { "1px", "2px", "3px", "4px", "5px", "7px" ,"9px"},
    { "1px", "2px", "3px", "4px", "5px", "6px", "8px" ,"10px"},
    { "1px", "2px", "3px", "4px", "5px", "6px", "8px", "10px","12px" },
    { "1px", "2px", "3px", "4px", "5px", "6px", "7px", "9px", "12px","14px" },
  };
   ...
   */
  public RoundedPanel(String cssStyle) {
    this(ALL, 2,cssStyle);
  }
   ...
   */
  public RoundedPanel(int corners,String cssStyle) {
    this(corners, 2, cssStyle);
  }
   ...
   */
  public RoundedPanel(int corners, int cornerHeight, String cssStyle) {
    ...
    if (inMask(corners, TOP)) {
        Element divBorder2 = addLineBorderHeight(corners & TOP, cornerHeight,"80px");
        DOM.setElementProperty(divBorder2, "className", RPSTYLE);
    ...
    if (inMask(corners, BOTTOM)) {
      ...
      Element divBorder = addLineBorderHeight(corners & BOTTOM, cornerHeight,"80px");
      DOM.setElementProperty(divBorder, "className", RPSTYLE);
    }
   ...
   */
  public RoundedPanel(Widget w, String cssStyle) {
    this(w, ALL, cssStyle);
  }
   ...
   * @param corners set custom rounded corners
   */
  public RoundedPanel(Widget w, int corners,String cssStyle) {
    this(w, corners, 2, cssStyle);
  }
   ...
   * @param cornerHeight height index between and including 1 and 9
   */
  public RoundedPanel(Widget w, int corners, int cornerHeight,String cssStyle) {
    this(corners, cornerHeight, cssStyle);
    setWidget(w);
  }
  ...
  public void emptyCornerStyleName() {
	    if (null != divt[0]) {
	      for (int i = 0; i < cornerHeight; ++i) {
	        DOM.setElementProperty(divt[i], "className", "");
	      }
	    }
	    if (null != divb[0]) {
	      for (int i = 0; i < cornerHeight; ++i) {
	        DOM.setElementProperty(divb[i], "className", "");
	      }
	    }
	  }
  ...
  private Element addLineBorderHeight(int corner, int heightIndex,String height) {
	    // margin 2 fields : top/bottom right/left  => "0 <width>px"
	    // margin 4 fields : top right bottom left  => "0 <width>px 0 <width>px"
	    String margin = (corner == TOP || corner == BOTTOM)
	        ? "0 " + RoundedPanel.CORNERMARGIN[cornerHeight - 1][heightIndex]
