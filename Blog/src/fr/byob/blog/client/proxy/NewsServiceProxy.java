...
public class NewsServiceProxy implements IObjectToolbarManagementServiceProxy<IPost>{

    private PostServiceAsync service;
    
    private final static NewsServiceProxy instance = new NewsServiceProxy();
    
    public static NewsServiceProxy getInstance(){
        return instance;
    }
    
    private NewsServiceProxy (){
    ...
    public void findObjects(int start, int end, AsyncCallback<List<IPost>> callback) {
        service.findPosts(start, end, callback);
    }

    public void countObjects(AsyncCallback<Integer> callback) {
        service.countPosts(callback);
    }
